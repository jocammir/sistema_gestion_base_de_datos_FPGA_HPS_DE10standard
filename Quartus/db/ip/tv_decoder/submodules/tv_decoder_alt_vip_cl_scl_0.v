...
`timescale 1 ps / 1 ps
module tv_decoder_alt_vip_cl_scl_0 (
	...
	wire          scheduler_av_st_cmd_ac_0_valid;          // scheduler:av_st_cmd_ac_valid_0 -> scaler_core:av_st_cmd_valid
	wire   [63:0] scheduler_av_st_cmd_ac_0_data;           // scheduler:av_st_cmd_ac_data_0 -> scaler_core:av_st_cmd_data
	wire          scheduler_av_st_cmd_ac_0_ready;          // scaler_core:av_st_cmd_ready -> scheduler:av_st_cmd_ac_ready_0
	wire          scheduler_av_st_cmd_ac_0_startofpacket;  // scheduler:av_st_cmd_ac_startofpacket_0 -> scaler_core:av_st_cmd_startofpacket
	wire          scheduler_av_st_cmd_ac_0_endofpacket;    // scheduler:av_st_cmd_ac_endofpacket_0 -> scaler_core:av_st_cmd_endofpacket
	wire          scaler_core_av_st_resp_valid;            // scaler_core:av_st_resp_valid -> scheduler:av_st_resp_ac_valid
	wire   [63:0] scaler_core_av_st_resp_data;             // scaler_core:av_st_resp_data -> scheduler:av_st_resp_ac_data
	wire          scaler_core_av_st_resp_ready;            // scheduler:av_st_resp_ac_ready -> scaler_core:av_st_resp_ready
	wire          scaler_core_av_st_resp_startofpacket;    // scaler_core:av_st_resp_startofpacket -> scheduler:av_st_resp_ac_startofpacket
	wire          scaler_core_av_st_resp_endofpacket;      // scaler_core:av_st_resp_endofpacket -> scheduler:av_st_resp_ac_endofpacket
	wire          line_buffer_av_st_dout_0_valid;          // line_buffer:av_st_dout_valid_0 -> scaler_core:av_st_din_valid
	wire   [79:0] line_buffer_av_st_dout_0_data;           // line_buffer:av_st_dout_data_0 -> scaler_core:av_st_din_data
	...
	wire          scaler_core_av_st_dout_valid;            // scaler_core:av_st_dout_valid -> output_mux:av_st_din_valid_0
	wire   [55:0] scaler_core_av_st_dout_data;             // scaler_core:av_st_dout_data -> output_mux:av_st_din_data_0
	wire          scaler_core_av_st_dout_ready;            // output_mux:av_st_din_ready_0 -> scaler_core:av_st_dout_ready
	wire          scaler_core_av_st_dout_startofpacket;    // scaler_core:av_st_dout_startofpacket -> output_mux:av_st_din_startofpacket_0
	wire          scaler_core_av_st_dout_endofpacket;      // scaler_core:av_st_dout_endofpacket -> output_mux:av_st_din_endofpacket_0
	...
	wire   [79:0] line_buffer_av_st_dout_data;             // port fragment
	...
	alt_vip_line_buffer #(
		...
		.av_st_dout_data          (line_buffer_av_st_dout_data[79:0])        //             .data
	);
	...
	alt_vip_scaler_scheduler #(
		...
		.av_st_resp_ac_valid          (scaler_core_av_st_resp_valid),            //  av_st_resp_ac.valid
		.av_st_resp_ac_startofpacket  (scaler_core_av_st_resp_startofpacket),    //               .startofpacket
		.av_st_resp_ac_endofpacket    (scaler_core_av_st_resp_endofpacket),      //               .endofpacket
		.av_st_resp_ac_data           (scaler_core_av_st_resp_data),             //               .data
		.av_st_resp_ac_ready          (scaler_core_av_st_resp_ready),            //               .ready
	...
	tv_decoder_alt_vip_cl_scl_0_scaler_core scaler_core (
		.clock                    (main_clock),                             // main_clock.clk
		.reset                    (main_reset),                             // main_reset.reset
		.av_st_cmd_valid          (scheduler_av_st_cmd_ac_0_valid),         //  av_st_cmd.valid
		.av_st_cmd_startofpacket  (scheduler_av_st_cmd_ac_0_startofpacket), //           .startofpacket
		.av_st_cmd_endofpacket    (scheduler_av_st_cmd_ac_0_endofpacket),   //           .endofpacket
		.av_st_cmd_data           (scheduler_av_st_cmd_ac_0_data),          //           .data
		.av_st_cmd_ready          (scheduler_av_st_cmd_ac_0_ready),         //           .ready
		.av_st_resp_valid         (scaler_core_av_st_resp_valid),           // av_st_resp.valid
		.av_st_resp_startofpacket (scaler_core_av_st_resp_startofpacket),   //           .startofpacket
		.av_st_resp_endofpacket   (scaler_core_av_st_resp_endofpacket),     //           .endofpacket
		.av_st_resp_data          (scaler_core_av_st_resp_data),            //           .data
		.av_st_resp_ready         (scaler_core_av_st_resp_ready),           //           .ready
	...
	alt_vip_packet_mux #(
		...
		.av_st_din_valid          ({input_demux_av_st_dout_1_valid,scaler_core_av_st_dout_valid}),                 // av_st_din_0.valid
		.av_st_din_startofpacket  ({input_demux_av_st_dout_1_startofpacket,scaler_core_av_st_dout_startofpacket}), //            .startofpacket
		.av_st_din_endofpacket    ({input_demux_av_st_dout_1_endofpacket,scaler_core_av_st_dout_endofpacket}),     //            .endofpacket
		.av_st_din_data           ({input_demux_av_st_dout_1_data[55:0],scaler_core_av_st_dout_data[55:0]}),       //            .data
	...
	assign line_buffer_av_st_dout_0_data = { line_buffer_av_st_dout_data[79:0] };
	...
	assign scaler_core_av_st_dout_ready = { output_mux_av_st_din_ready[0] };
